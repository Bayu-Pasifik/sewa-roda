  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Daftar akun Sewaroda untuk menikmati layanan rental mobil premium." />
      </Head>
      <div className="min-h-screen flex items-center justify-center bg-slate-100">
        ...
        >
          ...
          <form className="space-y-4">
            <div>
              <label className="block text-slate-800 mb-1">Nama Lengkap</label>
            ...
            <div>
              <label className="block text-slate-800 mb-1">Konfirmasi Password</label>
